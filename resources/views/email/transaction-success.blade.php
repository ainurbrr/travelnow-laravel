                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td style="width:550px;">
                                                                <img alt="gambar"
                                                                    src="{{ env("APP_URL", "http://localhost:8000").Storage::url($transaction->travel_package->galleries[0]->image) }}"
                                                                    style="border:none;display:block;outline:none;text-decoration:none;height:auto;width:100%;font-size:13px;"
                                                        ...
                                                        <tr>
                                                            <td align="left"
                                                                ...
                                                                <div
                                                                    ...
                                                                    Hi, {{ $transaction->user->name }} <br><br> Tiket digital kamu sudah
                                                                    berhasil dicetak. <br> Booking ID
                                                                    <strong>#{{ $transaction->id }}</strong></div>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td align="left"
                                                                ...
                                                                <table cellpadding="0" cellspacing="0" width="100%"
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td style="text-align: right;">{{ $details->nationality }}</td>
                                                                        </td>
                                                                    </tr>
                                                            ...
                                                            <td align="left"
                                                                ...
                                                                <table cellpadding="0" cellspacing="0" width="100%"
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td style="text-align: right;">{{ $transaction->travel_package->title }}</td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td><strong>Date and Time</strong></td>
                                                                        <td style="text-align: right;">{{ $transaction->travel_package->departure_date }}</td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                                                        </tr>
                                                                    ...
                                                                    <tbody>
                                                                        <tr>
                                                                            <td align="center" bgcolor="#FF9E53"
                                                                                ...
                                                                                valign="middle">
                                                                                <a href="{{ url('checkout/'.$transaction->id) }}"
                                        ...
                                        <tr>
                                            <td align="left"
                                                ...
                                                <table cellpadding="0" cellspacing="0" width="100%" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="width: 40px;">
                                                            <img src={{ url('frontend/images/support.svg') }}
                                                                width="50px">
                                                        </td>
                                                        <td
